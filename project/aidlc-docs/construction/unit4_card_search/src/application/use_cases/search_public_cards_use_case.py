"""SearchPublicCardsUseCase"""

from ..dto.commands import SearchPublicCardsCommand
...
class SearchPublicCardsUseCase:
    """공개 카드 검색 유스케이스"""
    ...
    async def execute(self, command: SearchPublicCardsCommand):
        """공개 카드 검색 실행"""
        # 검색 조건 생성
        ...
        # 검색 실행
        return await self._execution_service.execute_public_card_search(search_query)
